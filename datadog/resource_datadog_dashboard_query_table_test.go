...
const datadogDashboardQueryTableConfigDeprecated = `
...
var datadogDashboardQueryTableAssertsDeprecated = []string{
...
func TestAccDatadogDashboardQueryTableDeprecated(t *testing.T) {
	testAccDatadogDashboardWidgetUtil(t, datadogDashboardQueryTableConfigDeprecated, "datadog_dashboard.query_table_dashboard", datadogDashboardQueryTableAssertsDeprecated)
}
