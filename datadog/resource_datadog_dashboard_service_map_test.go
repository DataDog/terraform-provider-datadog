...
const datadogDashboardServiceMapConfigDeprecated = `
...
var datadogDashboardServiceMapAssertsDeprecated = []string{
	"title = {{uniq}}",
...
func TestAccDatadogDashboardServiceMapDeprecated(t *testing.T) {
	testAccDatadogDashboardWidgetUtil(t, datadogDashboardServiceMapConfigDeprecated, "datadog_dashboard.service_map_dashboard", datadogDashboardServiceMapAssertsDeprecated)
}
