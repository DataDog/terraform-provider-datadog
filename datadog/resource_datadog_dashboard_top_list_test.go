...
const datadogDashboardTopListConfigDeprecated = `
...
var datadogDashboardTopListAssertsDeprecated = []string{
	"description = Created using the Datadog provider in Terraform",
...
func TestAccDatadogDashboardTopListDeprecated(t *testing.T) {
	testAccDatadogDashboardWidgetUtil(t, datadogDashboardTopListConfigDeprecated, "datadog_dashboard.top_list_dashboard", datadogDashboardTopListAssertsDeprecated)
}
