...
resource "datadog_dashboard_v2" "tab_dashboard" {
	...
	configCreate = disableDashboardPlanValidation(configCreate)
	configUpdate = disableDashboardPlanValidation(configUpdate)
	configRemove = disableDashboardPlanValidation(configRemove)
