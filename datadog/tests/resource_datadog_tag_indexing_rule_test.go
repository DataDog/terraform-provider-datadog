...
func TestAccDatadogTagIndexingRule_Basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckDatadogTagIndexingRuleConfigBasic(uniq),
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemAttr("datadog_tag_indexing_rule.foo", "metric_name_matches.*", fmt.Sprintf("tf.test.%s.*", uniq)),
...
func TestAccDatadogTagIndexingRule_WithOptions(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckDatadogTagIndexingRuleConfigWithOptions(uniq),
				Check: resource.ComposeTestCheckFunc(
...
func TestAccDatadogTagIndexingRule_Update(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccCheckDatadogTagIndexingRuleConfigUpdated(uniq),
				Check: resource.ComposeTestCheckFunc(
...
func testAccCheckDatadogTagIndexingRuleConfigBasic(uniq string) string {
	return fmt.Sprintf(`
...
func testAccCheckDatadogTagIndexingRuleConfigUpdated(uniq string) string {
	return fmt.Sprintf(`
resource "datadog_tag_indexing_rule" "foo" {
...
func testAccCheckDatadogTagIndexingRuleConfigWithOptions(uniq string) string {
	return fmt.Sprintf(`
