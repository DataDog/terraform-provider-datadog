		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"datadog_on_call_team_routing_rules.team_rules_test", "rule.2.query", "tags.service:payment"),
					resource.TestCheckResourceAttrSet(
						"datadog_on_call_team_routing_rules.team_rules_test", "rule.2.action.0.escalation_policy.policy_id"),
					resource.TestCheckResourceAttr(
						"datadog_on_call_team_routing_rules.team_rules_test", "rule.2.action.0.escalation_policy.ack_timeout_minutes", "30"),
					resource.TestCheckResourceAttr(
						"datadog_on_call_team_routing_rules.team_rules_test", "rule.2.action.0.escalation_policy.urgency", "low"),
					resource.TestCheckResourceAttr(
						"datadog_on_call_team_routing_rules.team_rules_test", "rule.2.action.0.escalation_policy.support_hours.restriction.#", "5"),
				),
			},
		},
	})
