...
func checkServiceLevelObjectivesSingleResultDatasourceAttrs(accProvider *schema.Provider, uniq string) resource.TestCheckFunc {
...
func checkServiceLevelObjectivesMultipleResultsDatasourceAttrs(accProvider *schema.Provider, uniq string) resource.TestCheckFunc {
	return resource.ComposeTestCheckFunc(
		resource.TestCheckResourceAttrSet("data.datadog_service_level_objectives.foo", "id"),
