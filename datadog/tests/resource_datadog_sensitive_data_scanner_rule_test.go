...
func TestAccSensitiveDataScannerRuleWithStandardPattern(t *testing.T) {
	...
	data_source_name := "data.datadog_sensitive_data_scanner_standard_pattern.sample_sp"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					// name and description must match the standard pattern
					resource.TestCheckResourceAttrPair(
						resource_name_1, "name", data_source_name, "name"),
					resource.TestCheckResourceAttrPair(
						resource_name_1, "description", data_source_name, "description"),
					resource.TestCheckResourceAttr(
					...
					resource.TestCheckResourceAttrPair(
						resource_name_2, "name", data_source_name, "name"),
					resource.TestCheckResourceAttrPair(
						resource_name_2, "description", data_source_name, "description"),
					resource.TestCheckResourceAttr(
