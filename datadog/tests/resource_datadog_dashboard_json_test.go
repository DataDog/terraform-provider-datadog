		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						"datadog_dashboard_json.timeboard_json", "dashboard", fmt.Sprintf("{\"description\":\"\",\"layout_type\":\"ordered\",\"notify_list\":[],\"reflow_type\":\"fixed\",\"template_variables\":[],\"title\":\"%s\",\"widgets\":[]}", uniqueName)),
				),
			},
		},
	})
