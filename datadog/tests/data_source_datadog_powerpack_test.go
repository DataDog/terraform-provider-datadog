		...
		Steps: []resource.TestStep{
			{
				...
				Check:  checkDatasourcePowerpackAttrs(accProvider, uniq),
			},
		},
	})
}

func checkDatasourcePowerpackAttrs(accProvider func() (*schema.Provider, error), uniq string) resource.TestCheckFunc {
	return resource.ComposeTestCheckFunc(
		resource.TestCheckResourceAttrSet(
			"data.datadog_powerpack.pack_foo", "id"),
	)
}
