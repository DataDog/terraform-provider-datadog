...
var datadogDashboardHeatMapAsserts = []string{
	...
	// Deprecated widget
	"widget.1.heatmap_definition.0.title = Avg of system.cpu.user over account:prod by app",
	"widget.1.heatmap_definition.0.title_align = center",
	"widget.1.heatmap_definition.0.title_size = 16",
	"widget.1.heatmap_definition.0.request.0.q = avg:system.cpu.user{account:prod} by {app}",
	"widget.1.heatmap_definition.0.request.0.style.0.palette = blue",
	"widget.1.heatmap_definition.0.yaxis.0.include_zero = false",
	"widget.1.heatmap_definition.0.yaxis.0.label =",
	"widget.1.heatmap_definition.0.yaxis.0.max = 100",
	"widget.1.heatmap_definition.0.yaxis.0.scale =",
	"widget.1.heatmap_definition.0.yaxis.0.min =",
	"widget.1.heatmap_definition.0.time.live_span = 1mo",
	"widget.1.heatmap_definition.0.event.0.q = env:prod",
	"widget.1.heatmap_definition.0.event.0.tags_execution = and",
	"widget.1.heatmap_definition.0.show_legend = true",
	"widget.1.heatmap_definition.0.legend_size = 2",
	"widget.1.heatmap_definition.0.custom_link.# = 1",
	"widget.1.heatmap_definition.0.custom_link.0.label = Test Custom Link label",
	"widget.1.heatmap_definition.0.custom_link.0.link = https://app.datadoghq.com/dashboard/lists",
}
