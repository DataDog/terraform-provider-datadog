...
func TestResourceDatadogDowntimeRecurrenceTypeValidation(t *testing.T) {
	...
	for _, tc := range cases {
		_, errors := datadog.ValidateDatadogDowntimeRecurrenceType(tc.Value, "datadog_downtime_recurrence_type")
...
func TestResourceDatadogDowntimeRecurrenceWeekDaysValidation(t *testing.T) {
	...
	for _, tc := range cases {
		_, errors := datadog.ValidateDatadogDowntimeRecurrenceWeekDays(tc.Value, "datadog_downtime_recurrence_week_days")
