...
var datadogDashboardV2HeatmapHistogramAsserts = []string{
	...
	"widget.0.heatmap_definition.0.request.0.histogram_request.0.histogram_query.0.metric_query.0.data_source = metrics",
	"widget.0.heatmap_definition.0.request.0.histogram_request.0.histogram_query.0.metric_query.0.name = query1",
	"widget.0.heatmap_definition.0.request.0.histogram_request.0.histogram_query.0.metric_query.0.query = histogram:trace.servlet.request{*}",
	"widget.0.heatmap_definition.0.request.0.histogram_request.0.style.0.palette = dog_classic",
}
