...
const datadogPowerpackTimeseriesTest = `
resource "datadog_powerpack" "timeseries_powerpack" {
	name         = "{{uniq}}"
    tags = ["tag:foo1"]
...
var datadogPowerpackTimeseriesTestAsserts = []string{
	// Powerpack metadata
	"description = Created using the Datadog provider in Terraform",
	"widget.# = 1",
	"tags.# = 1",
...
const datadogPowerpackTimeseriesFormulaTest = `
resource "datadog_powerpack" "timeseries_formula_powerpack" {
	name         = "{{uniq}}"
    tags = ["tag:foo1"]
	description   = "Created using the Datadog provider in Terraform"
	template_variables {
...
const datadogPowerpackTimeseriesMultiComputeTest = `
resource "datadog_powerpack" "timeseries_multi_compute_powerpack" {
	name         = "{{uniq}}"
    tags = ["tag:foo1"]
	description   = "Created using the Datadog provider in Terraform"
	template_variables {
...
var datadogPowerpackTimeseriesMultiComputeTestAsserts = []string{
	// Powerpack metadata
	"description = Created using the Datadog provider in Terraform",
	"widget.# = 1",
	"tags.# = 1",
...
func TestAccDatadogPowerpackTimeseries(t *testing.T) {
	testAccDatadogDashboardWidgetUtil(t, datadogPowerpackTimeseriesTest, "datadog_powerpack.timeseries_powerpack", datadogPowerpackTimeseriesTestAsserts)
}

func TestAccDatadogPowerpackTimeseriesFormula(t *testing.T) {
	testAccDatadogDashboardWidgetUtil(t, datadogPowerpackTimeseriesFormulaTest, "datadog_powerpack.timeseries_formula_powerpack", datadogPowerpackTimeseriesFormulaTestAsserts)
}

func TestAccDatadogPowerpackTimeseriesMultiCompute(t *testing.T) {
	testAccDatadogDashboardWidgetUtil(t, datadogPowerpackTimeseriesMultiComputeTest, "datadog_powerpack.timeseries_multi_compute_powerpack", datadogPowerpackTimeseriesMultiComputeTestAsserts)
}
