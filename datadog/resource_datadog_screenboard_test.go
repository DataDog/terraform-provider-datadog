...
func TestAccDatadogScreenboard_update(t *testing.T) {
	...
	step1 := resource.TestStep{
		...
		Check: resource.ComposeTestCheckFunc(
			...
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.#", "19"),
			...
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.0.conditional_format.#", "0"),
			...
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.1.conditional_format.#", "0"),
			...
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.10.conditional_format.#", "0"),
			...
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.11.conditional_format.#", "0"),
			...
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.12.conditional_format.#", "0"),
			...
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.13.conditional_format.#", "0"),
			...
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.14.conditional_format.#", "0"),
			...
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.15.conditional_format.#", "0"),
			...
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.16.conditional_format.#", "0"),
			...
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.17.conditional_format.#", "0"),
			...
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.17.monitor.%", "1"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.17.monitor.id", "123456"),
			...
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.17.rule.#", "2"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.17.rule.0.color", "green"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.17.rule.0.threshold", "95"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.17.rule.0.timeframe", "Month-to-date"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.17.rule.1.color", "red"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.17.rule.1.threshold", "98"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.17.rule.1.timeframe", "7 days"),
			...
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.17.tile_def.#", "0"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.17.time.%", "0"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.17.timeframes.#", "3"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.17.timeframes.0", "7 days"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.17.timeframes.1", "Month-to-date"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.17.timeframes.2", "90 days"),
			...
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.17.type", "uptime"),
			...
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.17.x", "345"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.17.y", "5"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.alert_id", "0"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.auto_refresh", "false"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.bgcolor", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.check", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.color", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.color_preference", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.columns", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.conditional_format.#", "0"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.display_format", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.env", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.event_size", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.font_size", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.group", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.group_by.#", "0"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.grouping", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.height", "15"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.hide_zero_counts", "false"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.html", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.layout_version", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.legend", "false"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.legend_size", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.logset", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.manage_status_show_title", "false"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.manage_status_title_align", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.manage_status_title_size", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.manage_status_title_text", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.margin", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.monitor.%", "0"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.must_show_breakdown", "false"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.must_show_distribution", "false"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.must_show_errors", "false"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.must_show_hits", "false"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.must_show_latency", "false"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.must_show_resource_list", "false"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.params.%", "0"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.precision", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.query", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.rule.#", "0"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.service_name", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.service_service", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.size_version", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.sizing", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tags.#", "0"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.text", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.text_align", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.text_size", "auto"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tick", "false"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tick_edge", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tick_pos", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tile_def.#", "1"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tile_def.0.autoscale", "true"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tile_def.0.custom_unit", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tile_def.0.event.#", "0"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tile_def.0.group.#", "0"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tile_def.0.marker.#", "0"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tile_def.0.no_group_hosts", "false"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tile_def.0.no_metric_hosts", "false"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tile_def.0.node_type", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tile_def.0.precision", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tile_def.0.request.#", "1"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tile_def.0.request.0.aggregator", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tile_def.0.request.0.change_type", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tile_def.0.request.0.compare_to", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tile_def.0.request.0.conditional_format.#", "0"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tile_def.0.request.0.extra_col", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tile_def.0.request.0.increase_good", "false"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tile_def.0.request.0.limit", "200"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tile_def.0.request.0.metric", "process.stat.cpu.total_pct"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tile_def.0.request.0.order_by", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tile_def.0.request.0.order_dir", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tile_def.0.request.0.q", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tile_def.0.request.0.query_type", "process"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tile_def.0.request.0.style.%", "1"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tile_def.0.request.0.style.palette", "dog_classic_area"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tile_def.0.request.0.tag_filters.#", "0"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tile_def.0.request.0.text_filter", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tile_def.0.request.0.type", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tile_def.0.scope.#", "0"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tile_def.0.style.%", "0"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tile_def.0.text_align", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.tile_def.0.viz", "process"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.time.%", "0"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.timeframes.#", "0"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.title", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.title_align", "left"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.title_size", "16"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.type", "process"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.unit", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.url", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.viz_type", ""),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.width", "50"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.x", "365"),
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.18.y", "5"),
			...
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.2.conditional_format.#", "0"),
			...
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.3.conditional_format.#", "0"),
			...
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.4.conditional_format.#", "0"),
			...
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.5.conditional_format.#", "0"),
			...
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.6.conditional_format.#", "0"),
			...
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.7.conditional_format.#", "0"),
			...
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.8.conditional_format.#", "0"),
			...
			resource.TestCheckResourceAttr("datadog_screenboard.acceptance_test", "widget.9.conditional_format.#", "0"),
