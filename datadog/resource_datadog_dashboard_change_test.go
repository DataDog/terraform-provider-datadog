...
const datadogDashboardChangeConfigDeprecated = `
...
var datadogDashboardChangeAssertsDeprecated = []string{
...
func TestAccDatadogDashboardChangeDeprecated(t *testing.T) {
	testAccDatadogDashboardWidgetUtil(t, datadogDashboardChangeConfigDeprecated, "datadog_dashboard.change_dashboard", datadogDashboardChangeAssertsDeprecated)
}
