...
const datadogDashboardQueryValueConfigDeprecated = `
...
var datadogDashboardQueryValueAssertsDeprecated = []string{
...
func TestAccDatadogDashboardQueryValueDeprecated(t *testing.T) {
	testAccDatadogDashboardWidgetUtil(t, datadogDashboardQueryValueConfigDeprecated, "datadog_dashboard.query_value_dashboard", datadogDashboardQueryValueAssertsDeprecated)
}
