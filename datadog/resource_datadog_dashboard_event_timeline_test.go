...
const datadogDashboardEventTimelineConfigDeprecated = `
...
var datadogDashboardEventTimelineAssertsDeprecated = []string{
	"widget.0.layout.y = 5",
...
func TestAccDatadogDashboardEventTimelineDeprecated(t *testing.T) {
	testAccDatadogDashboardWidgetUtil(t, datadogDashboardEventTimelineConfigDeprecated, "datadog_dashboard.event_timeline_dashboard", datadogDashboardEventTimelineAssertsDeprecated)
}
