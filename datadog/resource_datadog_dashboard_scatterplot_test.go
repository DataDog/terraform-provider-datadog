...
const datadogDashboardScatterplotConfigDeprecated = `
...
var datadogDashboardScatterplotAssertsDeprecated = []string{
...
func TestAccDatadogDashboardScatterplotDeprecated(t *testing.T) {
	testAccDatadogDashboardWidgetUtil(t, datadogDashboardScatterplotConfigDeprecated, "datadog_dashboard.scatterplot_dashboard", datadogDashboardScatterplotAssertsDeprecated)
}
