...
const datadogDashboardTimeseriesConfigDeprecated = `
...
var datadogDashboardTimeseriesAssertsDeprecated = []string{
	"title = {{uniq}}",
	"is_read_only = true",
	"layout_type = ordered",
	"description = Created using the Datadog provider in Terraform",
...
func TestAccDatadogDashboardTimeseriesDeprecated(t *testing.T) {
	testAccDatadogDashboardWidgetUtil(t, datadogDashboardTimeseriesConfigDeprecated, "datadog_dashboard.timeseries_dashboard", datadogDashboardTimeseriesAssertsDeprecated)
}

const datadogDashboardTimeseriesMultiComputeConfigDeprecated = `
resource "datadog_dashboard" "timeseries_dashboard" {
	title         = "{{uniq}}"
	description   = "Created using the Datadog provider in Terraform"
	layout_type   = "ordered"
...
var datadogDashboardTimeseriesMultiComputeAssertsDeprecated = []string{
	"title = {{uniq}}",
	"is_read_only = true",
	"layout_type = ordered",
	"description = Created using the Datadog provider in Terraform",
...
func TestAccDatadogDashboardTimeseriesMultiComputeDeprecated(t *testing.T) {
	testAccDatadogDashboardWidgetUtil(t, datadogDashboardTimeseriesMultiComputeConfigDeprecated, "datadog_dashboard.timeseries_dashboard", datadogDashboardTimeseriesMultiComputeAssertsDeprecated)
}
