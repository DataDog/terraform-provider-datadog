...
// Used by the v1 datadog_dashboard resource.
// All five schema fields are pre-initialized so d.Set receives a complete map;
// Terraform 1.1.x stores 0 for absent TypeInt fields when given a partial map.
