...
var dataSourceToQueryType = map[string]string{
	...
	"network":              "event_query",
	"rum":                  "event_query",
	"security_signals":     "event_query",
	"profiles":             "event_query",
	"profiling":            "event_query",
	"audit":                "event_query",
	"events":               "event_query",
	"ci_tests":             "event_query",
	"ci_pipelines":         "event_query",
	"incident_analytics":   "event_query",
	"product_analytics":    "event_query",
	"on_call_events":       "event_query",
	"errors":               "event_query",
	"database_queries":     "event_query",
	"llm_observability":    "event_query",
	"monitors":             "event_query",
	"monitor_groups":       "event_query",
	"network_device_flows": "event_query",
	"synthetics_test_runs": "event_query",
