...
func resourceDatadogUserExists(d *schema.ResourceData, meta interface{}) (b bool, e error) {
	...
	if _, _, err := client.UsersApi.GetUser(auth, d.Id()); err != nil {
...
func resourceDatadogUserCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if _, _, err := client.UsersApi.CreateUser(auth, userCreate); err != nil {
	...
	res, _, err := client.UsersApi.UpdateUser(auth, d.Get("handle").(string), userUpdate)
...
func resourceDatadogUserRead(d *schema.ResourceData, meta interface{}) error {
	...
	userResponse, _, err := client.UsersApi.GetUser(auth, d.Id())
	if err != nil {
		return err
	}
...
func resourceDatadogUserUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	if _, _, err := client.UsersApi.UpdateUser(auth, d.Get("handle").(string), userUpdate); err != nil {
...
func resourceDatadogUserDelete(d *schema.ResourceData, meta interface{}) error {
	...
	if _, _, err := client.UsersApi.DisableUser(auth, d.Id()); err != nil {
		return err
	}
