...
const datadogDashboardHeatMapConfigDeprecated = `
...
var datadogDashboardHeatMapAssertsDeprecated = []string{
	"title = {{uniq}}",
	"description = Created using the Datadog provider in Terraform",
	"layout_type = ordered",
	"is_read_only = true",
...
func TestAccDatadogDashboardHeatMapDeprecated(t *testing.T) {
	testAccDatadogDashboardWidgetUtil(t, datadogDashboardHeatMapConfigDeprecated, "datadog_dashboard.heatmap_dashboard", datadogDashboardHeatMapAssertsDeprecated)
}
