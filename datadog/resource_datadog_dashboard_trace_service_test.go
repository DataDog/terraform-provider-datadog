...
const datadogDashboardTraceServiceConfigDeprecated = `
...
var datadogDashboardTraceServiceAssertsDeprecated = []string{
...
func TestAccDatadogDashboardTraceServiceDeprecated(t *testing.T) {
	testAccDatadogDashboardWidgetUtil(t, datadogDashboardTraceServiceConfigDeprecated, "datadog_dashboard.trace_service_dashboard", datadogDashboardTraceServiceAssertsDeprecated)
}
