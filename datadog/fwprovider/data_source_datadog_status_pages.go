...
var statusPageListItemAttrTypes = map[string]attr.Type{
	"id":                 types.StringType,
...
func (d *statusPagesDataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
		...
		Attributes: map[string]schema.Attribute{
			...
			"status_pages": schema.ListAttribute{
				...
				ElementType: types.ObjectType{
					AttrTypes: statusPageListItemAttrTypes,
				},
			},
		},
	}
