	...
	resp.Schema = schema.Schema{
		...
		Blocks: map[string]schema.Block{
			"default_tags": schema.ListNestedBlock{
				...
				Description: "[Experimental - Logs Pipelines, Monitors, Metric tag configuration, and Powerpack only] Configuration block containing settings to apply default resource tags across all resources.",
				NestedObject: schema.NestedBlockObject{
					Attributes: map[string]schema.Attribute{
						"tags": schema.MapAttribute{
							ElementType: types.StringType,
							Optional:    true,
							Description: "[Experimental - Logs Pipelines, Monitors, Metric tag configuration, and Powerpack only] Resource tags to be applied by default across all resources.",
						},
					},
				},
			},
