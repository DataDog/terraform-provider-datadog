...
- `tags` (List of String) Tags of the rule, propagated to findings and signals. Defaults to empty list. Note: if default tags are present at provider level, they will be added to this resource.
