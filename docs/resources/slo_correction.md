...
- `slo_id` (String) ID of the single SLO that this correction will be applied to.
- `slo_query` (String) Query that matches the SLOs this correction will be applied to.
