...
- `priority` (Number) Priority level of the rule. Used to order sensitive data discovered in the sds summary page. It must be between 1 and 5 (1 is the most important).
