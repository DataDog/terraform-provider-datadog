...
<a id="nestedblock--widget--geomap_definition--request--rum_query--conditional_formats"></a>
### Nested Schema for `widget.geomap_definition.request.rum_query.conditional_formats`
...
- **apm_dependency_stats_query** (Block List, Max: 1) The APM Dependency Stats query using formulas and functions. (see [below for nested schema](#nestedblock--widget--geomap_definition--request--rum_query--apm_dependency_stats_query))
- **apm_resource_stats_query** (Block List, Max: 1) The APM Resource Stats query using formulas and functions. (see [below for nested schema](#nestedblock--widget--geomap_definition--request--rum_query--apm_resource_stats_query))
...
<a id="nestedblock--widget--geomap_definition--request--rum_query--apm_dependency_stats_query"></a>
### Nested Schema for `widget.geomap_definition.request.rum_query.apm_dependency_stats_query`
...
<a id="nestedblock--widget--geomap_definition--request--rum_query--apm_resource_stats_query"></a>
### Nested Schema for `widget.geomap_definition.request.rum_query.apm_resource_stats_query`
...
<a id="nestedblock--widget--group_definition--widget--id--request--rum_query--conditional_formats"></a>
...
- **apm_dependency_stats_query** (Block List, Max: 1) The APM Dependency Stats query using formulas and functions. (see [below for nested schema](#nestedblock--widget--group_definition--widget--id--request--rum_query--apm_dependency_stats_query))
- **apm_resource_stats_query** (Block List, Max: 1) The APM Resource Stats query using formulas and functions. (see [below for nested schema](#nestedblock--widget--group_definition--widget--id--request--rum_query--apm_resource_stats_query))
...
<a id="nestedblock--widget--group_definition--widget--id--request--rum_query--apm_dependency_stats_query"></a>
...
<a id="nestedblock--widget--group_definition--widget--id--request--rum_query--apm_resource_stats_query"></a>
### Nested Schema for `widget.group_definition.widget.id.request.rum_query.process_query`
...
- **alias** (String) An expression alias.
- **cell_display_mode** (String) A list of display modes for each table cell. Valid values are `number`, `bar`.
- **conditional_formats** (Block List) Conditional formats allow you to set the color of your widget content or background depending on the rule applied to your data. Multiple `conditional_formats` blocks are allowed using the structure below. (see [below for nested schema](#nestedblock--widget--group_definition--widget--id--request--security_query--conditional_formats))
...
<a id="nestedblock--widget--group_definition--widget--id--request--security_query--conditional_formats"></a>
...
- **apm_dependency_stats_query** (Block List, Max: 1) The APM Dependency Stats query using formulas and functions. (see [below for nested schema](#nestedblock--widget--group_definition--widget--id--request--security_query--apm_dependency_stats_query))
- **apm_resource_stats_query** (Block List, Max: 1) The APM Resource Stats query using formulas and functions. (see [below for nested schema](#nestedblock--widget--group_definition--widget--id--request--security_query--apm_resource_stats_query))
...
<a id="nestedblock--widget--group_definition--widget--id--request--security_query--apm_dependency_stats_query"></a>
...
<a id="nestedblock--widget--group_definition--widget--id--request--security_query--apm_resource_stats_query"></a>
### Nested Schema for `widget.group_definition.widget.id.request.security_query.process_query`
...
<a id="nestedblock--widget--group_definition--widget--id--request--style--conditional_formats"></a>
...
- **apm_dependency_stats_query** (Block List, Max: 1) The APM Dependency Stats query using formulas and functions. (see [below for nested schema](#nestedblock--widget--group_definition--widget--id--request--style--apm_dependency_stats_query))
- **apm_resource_stats_query** (Block List, Max: 1) The APM Resource Stats query using formulas and functions. (see [below for nested schema](#nestedblock--widget--group_definition--widget--id--request--style--apm_resource_stats_query))
...
<a id="nestedblock--widget--group_definition--widget--id--request--style--apm_dependency_stats_query"></a>
...
<a id="nestedblock--widget--group_definition--widget--id--request--style--apm_resource_stats_query"></a>
### Nested Schema for `widget.group_definition.widget.id.request.style.process_query`
...
- **cell_display_mode** (String) A list of display modes for each table cell. Valid values are `number`, `bar`.
- **conditional_formats** (Block List) Conditional formats allow you to set the color of your widget content or background depending on the rule applied to your data. Multiple `conditional_formats` blocks are allowed using the structure below. (see [below for nested schema](#nestedblock--widget--query_table_definition--request--security_query--conditional_formats))
- **limit** (Block List, Max: 1) The options for limiting results returned. (see [below for nested schema](#nestedblock--widget--query_table_definition--request--security_query--limit))

<a id="nestedblock--widget--query_table_definition--request--security_query--conditional_formats"></a>
### Nested Schema for `widget.query_table_definition.request.security_query.conditional_formats`
...
<a id="nestedblock--widget--query_table_definition--request--security_query--limit"></a>
### Nested Schema for `widget.query_table_definition.request.security_query.limit`
...
- **apm_dependency_stats_query** (Block List, Max: 1) The APM Dependency Stats query using formulas and functions. (see [below for nested schema](#nestedblock--widget--query_table_definition--request--security_query--apm_dependency_stats_query))
- **apm_resource_stats_query** (Block List, Max: 1) The APM Resource Stats query using formulas and functions. (see [below for nested schema](#nestedblock--widget--query_table_definition--request--security_query--apm_resource_stats_query))
- **event_query** (Block List, Max: 1) A timeseries formula and functions events query. (see [below for nested schema](#nestedblock--widget--query_table_definition--request--security_query--event_query))
- **metric_query** (Block List, Max: 1) A timeseries formula and functions metrics query. (see [below for nested schema](#nestedblock--widget--query_table_definition--request--security_query--metric_query))
- **process_query** (Block List, Max: 1) The process query using formulas and functions. (see [below for nested schema](#nestedblock--widget--query_table_definition--request--security_query--process_query))

<a id="nestedblock--widget--query_table_definition--request--security_query--apm_dependency_stats_query"></a>
### Nested Schema for `widget.query_table_definition.request.security_query.apm_dependency_stats_query`
...
<a id="nestedblock--widget--query_table_definition--request--security_query--apm_resource_stats_query"></a>
### Nested Schema for `widget.query_table_definition.request.security_query.apm_resource_stats_query`
...
<a id="nestedblock--widget--query_table_definition--request--security_query--event_query"></a>
### Nested Schema for `widget.query_table_definition.request.security_query.event_query`

Required:

- **compute** (Block List, Min: 1) The compute options. (see [below for nested schema](#nestedblock--widget--query_table_definition--request--security_query--event_query--compute))
- **data_source** (String) The data source for event platform-based queries. Valid values are `logs`, `spans`, `network`, `rum`, `security_signals`, `profiles`, `audit`, `events`.
- **name** (String) The name of query for use in formulas.

Optional:

- **group_by** (Block List) Group by options. (see [below for nested schema](#nestedblock--widget--query_table_definition--request--security_query--event_query--group_by))
- **indexes** (List of String) An array of index names to query in the stream.
- **search** (Block List, Max: 1) The search options. (see [below for nested schema](#nestedblock--widget--query_table_definition--request--security_query--event_query--search))

<a id="nestedblock--widget--query_table_definition--request--security_query--event_query--compute"></a>
### Nested Schema for `widget.query_table_definition.request.security_query.event_query.search`
...
<a id="nestedblock--widget--query_table_definition--request--security_query--event_query--group_by"></a>
### Nested Schema for `widget.query_table_definition.request.security_query.event_query.search`
...
- **limit** (Number) The number of groups to return.
- **sort** (Block List, Max: 1) The options for sorting group by results. (see [below for nested schema](#nestedblock--widget--query_table_definition--request--security_query--event_query--search--sort))

<a id="nestedblock--widget--query_table_definition--request--security_query--event_query--search--sort"></a>
### Nested Schema for `widget.query_table_definition.request.security_query.event_query.search.sort`
...
<a id="nestedblock--widget--query_table_definition--request--security_query--event_query--search"></a>
### Nested Schema for `widget.query_table_definition.request.security_query.event_query.search`
...
<a id="nestedblock--widget--query_table_definition--request--security_query--metric_query"></a>
### Nested Schema for `widget.query_table_definition.request.security_query.metric_query`
...
<a id="nestedblock--widget--query_table_definition--request--security_query--process_query"></a>
### Nested Schema for `widget.query_table_definition.request.security_query.process_query`
...
- **alias** (String) An expression alias.
- **cell_display_mode** (String) A list of display modes for each table cell. Valid values are `number`, `bar`.
- **conditional_formats** (Block List) Conditional formats allow you to set the color of your widget content or background depending on the rule applied to your data. Multiple `conditional_formats` blocks are allowed using the structure below. (see [below for nested schema](#nestedblock--widget--query_value_definition--request--security_query--conditional_formats))
...
<a id="nestedblock--widget--query_value_definition--request--security_query--conditional_formats"></a>
### Nested Schema for `widget.query_value_definition.request.security_query.conditional_formats`
...
- **apm_dependency_stats_query** (Block List, Max: 1) The APM Dependency Stats query using formulas and functions. (see [below for nested schema](#nestedblock--widget--query_value_definition--request--security_query--apm_dependency_stats_query))
- **apm_resource_stats_query** (Block List, Max: 1) The APM Resource Stats query using formulas and functions. (see [below for nested schema](#nestedblock--widget--query_value_definition--request--security_query--apm_resource_stats_query))
...
<a id="nestedblock--widget--query_value_definition--request--security_query--apm_dependency_stats_query"></a>
### Nested Schema for `widget.query_value_definition.request.security_query.apm_dependency_stats_query`
...
<a id="nestedblock--widget--query_value_definition--request--security_query--apm_resource_stats_query"></a>
### Nested Schema for `widget.query_value_definition.request.security_query.apm_resource_stats_query`
...
- **alias** (String) An expression alias.
- **cell_display_mode** (String) A list of display modes for each table cell. Valid values are `number`, `bar`.
- **conditional_formats** (Block List) Conditional formats allow you to set the color of your widget content or background depending on the rule applied to your data. Multiple `conditional_formats` blocks are allowed using the structure below. (see [below for nested schema](#nestedblock--widget--timeseries_definition--request--style--conditional_formats))
...
<a id="nestedblock--widget--timeseries_definition--request--style--conditional_formats"></a>
### Nested Schema for `widget.timeseries_definition.request.style.conditional_formats`
...
- **apm_dependency_stats_query** (Block List, Max: 1) The APM Dependency Stats query using formulas and functions. (see [below for nested schema](#nestedblock--widget--timeseries_definition--request--style--apm_dependency_stats_query))
- **apm_resource_stats_query** (Block List, Max: 1) The APM Resource Stats query using formulas and functions. (see [below for nested schema](#nestedblock--widget--timeseries_definition--request--style--apm_resource_stats_query))
...
<a id="nestedblock--widget--timeseries_definition--request--style--apm_dependency_stats_query"></a>
### Nested Schema for `widget.timeseries_definition.request.style.apm_dependency_stats_query`
...
<a id="nestedblock--widget--timeseries_definition--request--style--apm_resource_stats_query"></a>
### Nested Schema for `widget.timeseries_definition.request.style.apm_resource_stats_query`
...
- **alias** (String) An expression alias.
- **cell_display_mode** (String) A list of display modes for each table cell. Valid values are `number`, `bar`.
- **conditional_formats** (Block List) Conditional formats allow you to set the color of your widget content or background depending on the rule applied to your data. Multiple `conditional_formats` blocks are allowed using the structure below. (see [below for nested schema](#nestedblock--widget--toplist_definition--request--style--conditional_formats))
...
<a id="nestedblock--widget--toplist_definition--request--style--conditional_formats"></a>
### Nested Schema for `widget.toplist_definition.request.style.conditional_formats`
...
- **apm_dependency_stats_query** (Block List, Max: 1) The APM Dependency Stats query using formulas and functions. (see [below for nested schema](#nestedblock--widget--toplist_definition--request--style--apm_dependency_stats_query))
- **apm_resource_stats_query** (Block List, Max: 1) The APM Resource Stats query using formulas and functions. (see [below for nested schema](#nestedblock--widget--toplist_definition--request--style--apm_resource_stats_query))
...
<a id="nestedblock--widget--toplist_definition--request--style--apm_dependency_stats_query"></a>
### Nested Schema for `widget.toplist_definition.request.style.apm_dependency_stats_query`
...
<a id="nestedblock--widget--toplist_definition--request--style--apm_resource_stats_query"></a>
### Nested Schema for `widget.toplist_definition.request.style.apm_resource_stats_query`
