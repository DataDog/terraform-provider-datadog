...
- **layout_type** (String) The layout type of the dashboard, either 'free' or 'ordered'. Valid values are `ordered`, `free`.
...
- **reflow_type** (String) The reflow type of a new dashboard layout. Set this only when layout type is ‘ordered’. If set to ‘fixed’, the dashboard expect all widgets to have a layout, and if it’s set to ‘auto’, widgets should not have layouts. Valid values are `auto`, `fixed`.
...
- **viz_type** (String) Type of visualization to use when displaying the widget. Either `timeseries` or `toplist`. Valid values are `timeseries`, `toplist`.

Optional:

- **live_span** (String) The timeframe to use when displaying the widget. One of `10m`, `30m`, `1h`, `4h`, `1d`, `2d`, `1w`, `1mo`, `3mo`, `6mo`, `1y`, `alert`. Valid values are `1m`, `5m`, `10m`, `15m`, `30m`, `1h`, `4h`, `1d`, `2d`, `1w`, `1mo`, `3mo`, `6mo`, `1y`, `alert`.
...
- **change_type** (String) Whether to show absolute or relative change. One of `absolute`, `relative`. Valid values are `absolute`, `relative`.
- **compare_to** (String) Choose from when to compare current data to. One of `hour_before`, `day_before`, `week_before` or `month_before`. Valid values are `hour_before`, `day_before`, `week_before`, `month_before`.
...
- **order_by** (String) One of `change`, `name`, `present` (present value) or `past` (past value). Valid values are `change`, `name`, `present`, `past`.
- **order_dir** (String) Either `asc` (ascending) or `desc` (descending). Valid values are `asc`, `desc`.
...
- **grouping** (String) Either `check` or `cluster`, depending on whether the widget should use a single check or a cluster of checks. Valid values are `check`, `cluster`.
...
- **event_size** (String) The size to use to display an event. One of `s`, `l` Valid values are `s`, `l`.
- **live_span** (String) The timeframe to use when displaying the widget. One of `10m`, `30m`, `1h`, `4h`, `1d`, `2d`, `1w`, `1mo`, `3mo`, `6mo`, `1y`, `alert`. Valid values are `1m`, `5m`, `10m`, `15m`, `30m`, `1h`, `4h`, `1d`, `2d`, `1w`, `1mo`, `3mo`, `6mo`, `1y`, `alert`.
...
- **layout_type** (String) The layout type of the group, only 'ordered' for now. Valid values are `ordered`.
...
- **node_type** (String) The type of node used. Either `host` or `container`. Valid values are `host`, `container`.
...
- **margin** (String) The margins to use around the image. Either `sm`, `md`, or `lg`. Note: `small` and `large` values are deprecated. Valid values are `sm`, `md`, `lg`, `small`, `large`.
- **sizing** (String) The preferred method to adapt the dimensions of the image. The values are based on the image `object-fit` CSS properties and are either: `fill`, `contain`, `cover`, `none` or `scale-down`. Note: `zoom`, `fit` and `center` values are deprecated. Valid values are `fill`, `contain`, `cover`, `none`, `scale-down`, `zoom`, `fit`, `center`.
...
- **indexes** (List of String) An array of index names to query in the stream.
- **live_span** (String) The timeframe to use when displaying the widget. One of `10m`, `30m`, `1h`, `4h`, `1d`, `2d`, `1w`, `1mo`, `3mo`, `6mo`, `1y`, `alert`. Valid values are `1m`, `5m`, `10m`, `15m`, `30m`, `1h`, `4h`, `1d`, `2d`, `1w`, `1mo`, `3mo`, `6mo`, `1y`, `alert`.
- **message_display** (String) One of: ['inline', 'expanded-md', 'expanded-lg'] Valid values are `inline`, `expanded-md`, `expanded-lg`.
- **query** (String) The query to use in the widget.
...
- **color_preference** (String) Whether to colorize text or background. One of `text`, `background`. Valid values are `background`, `text`.
- **display_format** (String) The display setting to use. One of `counts`, `list`, or `countsAndList`. Valid values are `counts`, `countsAndList`, `list`.
...
- **sort** (String) The method to use to sort monitors. Example: `status,asc`. Valid values are `name`, `group`, `status`, `tags`, `triggered`, `group,asc`, `group,desc`, `name,asc`, `name,desc`, `status,asc`, `status,desc`, `tags,asc`, `tags,desc`, `triggered,asc`, `triggered,desc`.
- **summary_type** (String) One of: ['monitors', 'groups', 'combined'] Valid values are `monitors`, `groups`, `combined`.
- **title** (String) The title of the widget.
- **title_align** (String) The alignment of the widget's title. One of `left`, `center`, or `right`. Valid values are `center`, `left`, `right`.
- **title_size** (String) The size of the widget's title. Default is 16.
...
- **text_align** (String) The alignment of the widget's text. One of `left`, `center`, or `right`. Valid values are `center`, `left`, `right`.
- **tick_edge** (String) When `tick = true`, string indicating on which side of the widget the tick should be displayed. One of `bottom`, `top`, `left`, `right`. Valid values are `bottom`, `left`, `right`, `top`.
...
- **has_search_bar** (String) Controls the display of the search bar. One of `auto`, `always`, `never`. Valid values are `always`, `never`, `auto`.
- **live_span** (String) The timeframe to use when displaying the widget. One of `10m`, `30m`, `1h`, `4h`, `1d`, `2d`, `1w`, `1mo`, `3mo`, `6mo`, `1y`, `alert`. Valid values are `1m`, `5m`, `10m`, `15m`, `30m`, `1h`, `4h`, `1d`, `2d`, `1w`, `1mo`, `3mo`, `6mo`, `1y`, `alert`.
...
- **aggregator** (String) The aggregator to use for time aggregation. One of `avg`, `min`, `max`, `sum`, `last`. Valid values are `avg`, `last`, `max`, `min`, `sum`.
...
- **order** (String) The sort order for the rows. One of `desc` or `asc`. Valid values are `asc`, `desc`.
...
- **comparator** (String) Comparator to use. One of `>`, `>=`, `<`, or `<=`. Valid values are `>`, `>=`, `<`, `<=`.
- **palette** (String) Color palette to apply. One of `blue`, `custom_bg`, `custom_image`, `custom_text`, `gray_on_white`, `grey`, `green`, `orange`, `red`, `red_on_white`, `white_on_gray`, `white_on_green`, `green_on_white`, `white_on_red`, `white_on_yellow`, `yellow_on_white`, `black_on_light_yellow`, `black_on_light_green` or `black_on_light_red`. Valid values are `blue`, `custom_bg`, `custom_image`, `custom_text`, `gray_on_white`, `grey`, `green`, `orange`, `red`, `red_on_white`, `white_on_gray`, `white_on_green`, `green_on_white`, `white_on_red`, `white_on_yellow`, `yellow_on_white`, `black_on_light_yellow`, `black_on_light_green`, `black_on_light_red`.
...
- **view_mode** (String) View mode for the widget. One of `overall`, `component`, or `both`. Valid values are `overall`, `component`, `both`.
...
- **legend_layout** (String) The layout of the legend displayed in the widget. One of `auto`, `horizontal`, `vertical`. Valid values are `auto`, `horizontal`, `vertical`.
- **legend_size** (String) The size of the legend displayed in the widget.
- **live_span** (String) The timeframe to use when displaying the widget. One of `10m`, `30m`, `1h`, `4h`, `1d`, `2d`, `1w`, `1mo`, `3mo`, `6mo`, `1y`, `alert`. Valid values are `1m`, `5m`, `10m`, `15m`, `30m`, `1h`, `4h`, `1d`, `2d`, `1w`, `1mo`, `3mo`, `6mo`, `1y`, `alert`.
...
- **display_type** (String) How the marker lines will look. Possible values are one of {`error`, `warning`, `info`, `ok`} combined with one of {`dashed`, `solid`, `bold`}. Example: `error dashed`. Valid values are `area`, `bars`, `line`.
...
- **line_type** (String) Type of lines displayed. Available values are: `dashed`, `dotted`, or `solid`. Valid values are `dashed`, `dotted`, `solid`.
- **line_width** (String) Width of line displayed. Available values are: `normal`, `thick`, or `thin`. Valid values are `normal`, `thick`, `thin`.
- **palette** (String) Color palette to apply to the widget. The available options are available here: https://docs.datadoghq.com/dashboards/widgets/timeseries/#appearance.
...
- **display_format** (String) Number of columns to display. Available values are: `one_column`, `two_column`, or `three_column`. Valid values are `one_column`, `two_column`, `three_column`.
- **live_span** (String) The timeframe to use when displaying the widget. One of `10m`, `30m`, `1h`, `4h`, `1d`, `2d`, `1w`, `1mo`, `3mo`, `6mo`, `1y`, `alert`. Valid values are `1m`, `5m`, `10m`, `15m`, `30m`, `1h`, `4h`, `1d`, `2d`, `1w`, `1mo`, `3mo`, `6mo`, `1y`, `alert`.
...
- **size_format** (String) Size of the widget. Available values are: `small`, `medium`, or `large`. Valid values are `small`, `medium`, `large`.
- **title** (String) The title of the widget.
- **title_align** (String) The alignment of the widget's title. One of `left`, `center`, or `right`. Valid values are `center`, `left`, `right`.
- **title_size** (String) The size of the widget's title. Default is 16.
