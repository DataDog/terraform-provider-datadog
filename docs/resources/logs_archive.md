...
- **azure** (Map of String, Optional, Deprecated) **DEPRECATED** Define `azure_archive` list with one element instead. Definition of an azure archive.
- **azure_archive** (Block List, Max: 1) Definition of an azure archive. (see [below for nested schema](#nestedblock--azure_archive))
- **gcs** (Map of String, Optional, Deprecated) **DEPRECATED** Define `gcs_archive` list with one element instead. Definition of a GCS archive.
...
- **s3** (Map of String, Optional, Deprecated) **DEPRECATED** Define `s3_archive` list with one element instead. Definition of an s3 archive.
