...
- `decoder_processor` (Block List, Max: 1) Decoder Processor. More information can be found in the [official docs](...) (see [below for nested schema](#nestedblock--processor--decoder_processor))
...
- `decoder_processor` (Block List, Max: 1) Decoder Processor. More information can be found in the [official docs](...) (see [below for nested schema](#nestedblock--processor--pipeline--processor--decoder_processor))
