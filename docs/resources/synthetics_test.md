...
- **assertions** (List of Map of String, Optional, Deprecated) **DEPRECATED** Use assertion instead List of assertions.
...
- **options** (Map of String, Optional, Deprecated) **DEPRECATED** This parameter is deprecated, please use `options_list`
- **options_list** (Block List, Max: 1) (see [below for nested schema](#nestedblock--options_list))
- **request** (Map of String, Optional, Deprecated) **DEPRECATED** Define `request_definition` list with one element instead. The synthetics test request. Required if `type = "api"`.
...
- **step** (Block List, Deprecated) **DEPRECATED** This parameter is deprecated, please use `browser_step` Steps for browser tests. (see [below for nested schema](#nestedblock--step))
...
- **variable** (Block List, Deprecated) **DEPRECATED** This parameter is deprecated, please use `browser_variable` Variables used for a browser test steps. Multiple `browser_variable` blocks are allowed with the structure below. (see [below for nested schema](#nestedblock--variable))
