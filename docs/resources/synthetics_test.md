...
- **status** (String) Define whether you want to start (`live`) or pause (`paused`) a Synthetic test. Allowed enum values: `live`, `paused` Valid values are `live`, `paused`.
- **type** (String) Synthetics test type (`api` or `browser`). Valid values are `api`, `browser`.
...
- **device_ids** (List of String) Array with the different device IDs used to run the test. Allowed enum values: `laptop_large`, `tablet`, `mobile_small` (only available for `browser` tests). Valid values are `laptop_large`, `tablet`, `mobile_small`, `chrome.laptop_large`, `chrome.tablet`, `chrome.mobile_small`, `firefox.laptop_large`, `firefox.tablet`, `firefox.mobile_small`.
...
- **subtype** (String) When `type` is `api`, choose from `http`, `ssl`, `tcp`, `dns`, `icmp` or `multi`. Defaults to `http`. Valid values are `http`, `ssl`, `tcp`, `dns`, `multi`, `icmp`.
...
- **request_headers** (Map of String) Header name and value map.
- **request_query** (Map of String) Query arguments name and value map.
- **subtype** (String) The subtype of the Synthetic multistep API test step, currently only supporting `http`. Valid values are `http`.
...
- **type** (String) Property of the Synthetics Test Response to use for the variable: `http_body` or `http_header` Valid values are `http_body`, `http_header`.
...
- **type** (String) Type of parser for a Synthetics global variable from a synthetics test: `raw`, `json_path`, `regex` Valid values are `raw`, `json_path`, `regex`.
...
- **method** (String) The HTTP method. One of `DELETE`, `GET`, `HEAD`, `OPTIONS`, `PATCH`, `POST`, `PUT`. Valid values are `GET`, `POST`, `PATCH`, `PUT`, `DELETE`, `HEAD`, `OPTIONS`.
...
- **type** (String) Type of the step. Refer to [Datadog documentation](https://docs.datadoghq.com/api/v1/synthetics/#create-a-test) for the complete list of available types. Valid values are `assertCurrentUrl`, `assertElementAttribute`, `assertElementContent`, `assertElementPresent`, `assertEmail`, `assertFileDownload`, `assertFromJavascript`, `assertPageContains`, `assertPageLacks`, `click`, `extractFromJavascript`, `extractVariable`, `goToEmailLink`, `goToUrl`, `goToUrlAndMeasureTti`, `hover`, `playSubTest`, `pressKey`, `refresh`, `runApiTest`, `scroll`, `selectOption`, `typeText`, `uploadFiles`, `wait`.
...
- **type** (String) Type of browser test variable. Allowed enum values: `element`, `email`, `global`, `javascript`, `text`. Valid values are `element`, `email`, `global`, `javascript`, `text`.
...
- **name** (String) Name of the variable.
- **type** (String) Type of test configuration variable. Allowed enum values: `text`, `global`. Valid values are `global`, `text`.
...
- **tick_every** (Number) How often the test should run (in seconds). Current possible values are `30`, `60`, `900`, `1800`, `3600`, `21600`, `43200`, `86400`, `604800` for API tests or `300` for browser tests. Valid values are `30`, `60`, `300`, `900`, `1800`, `3600`, `21600`, `43200`, `86400`, `604800`.
