...
page_title: "datadog_security_findings_inbox_rules_order Resource - terraform-provider-datadog"
subcategory: ""
description: |-
...
# datadog_security_findings_inbox_rules_order (Resource)
...
- `rule_ids` (List of String) The ordered list of all inbox rule IDs. The order of IDs in this attribute defines the evaluation order of the inbox rules.
