...
body:
  ...
  - type: input
    ...
    attributes:
      ...
      description: Run `terraform providers` to show the version of the Datadog terraform provider. If you are not running the latest version of the Datadog terraform provider, please upgrade because your issue may have already been fixed.
  ...
  - type: textarea
    ...
    attributes:
      ...
      description: |
        Please provide a link to a GitHub Gist containing the complete debug or panic output: https://www.terraform.io/docs/internals/debugging.html.
