...
// SLOCorrectionListResponseData The response object of a list of SLO corrections
type SLOCorrectionListResponseData struct {
...
func NewSLOCorrectionListResponseData() *SLOCorrectionListResponseData {
	this := SLOCorrectionListResponseData{}
...
func (o SLOCorrectionListResponseData) MarshalJSON() ([]byte, error) {
...
type NullableSLOCorrectionListResponseData struct {
	value *SLOCorrectionListResponseData
	isSet bool
}

func (v NullableSLOCorrectionListResponseData) Get() *SLOCorrectionListResponseData {
	return v.value
}

func (v *NullableSLOCorrectionListResponseData) Set(val *SLOCorrectionListResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableSLOCorrectionListResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableSLOCorrectionListResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSLOCorrectionListResponseData(val *SLOCorrectionListResponseData) *NullableSLOCorrectionListResponseData {
	return &NullableSLOCorrectionListResponseData{value: val, isSet: true}
}

func (v NullableSLOCorrectionListResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSLOCorrectionListResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
