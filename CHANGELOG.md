...
* [aws_cur_config][custom_allocation_rule] Minor fixes to Cloud Cost resources to prevent apply needed after imports by @alextmeyer in https://github.com/DataDog/terraform-provider-datadog/pull/3287
### FEATURES
...
* [datadog_monitor][feature] Update Monitors terraform to support draft monitors by @kevinpombo-datadog in https://github.com/DataDog/terraform-provider-datadog/pull/3275
...
**Full Changelog**: https://github.com/DataDog/terraform-provider-datadog/compare/v3.76.0...vv3.77.0
