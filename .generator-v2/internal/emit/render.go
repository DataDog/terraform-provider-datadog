...
// funcMap holds the only template helpers. By design it carries presentation
// helpers, not derivation: a View arrives fully populated. "title" upper-cases
// the first rune (incidentType -> IncidentType) for the constructor name.
